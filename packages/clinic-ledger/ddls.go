		...
		Examples: []pkgmgr.ExampleSpec{
			{
				...
				ExpectedOutcome: "Validates the patient is alive. Atomically commits vtx.account.<sameNanoID> (root data {} — D5) " +
		...
		Examples: []pkgmgr.ExampleSpec{
			{
				...
				Payload: map[string]any{"accountKey": "vtx.account.<NanoID>", "amountCents": 2500, "memo": "Office visit copay"},
			...
			},
			{
				...
				Payload: map[string]any{"accountKey": "vtx.account.<NanoID>", "amountCents": 2500, "memo": "Insurance payment — claim #4471"},
