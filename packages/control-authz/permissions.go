...
// Permissions returns the 16 ctrl.<component>.<verb> platform permissions,
...
//
// The four identity-bound Personal Lens ops (register/deregister/hydrate/
// sessionkey) additionally grant to the consumer role —
// per-identity-nats-subscribe-acl-design.md §3.3/§3.4 (Fire 2);
// edge-lattice-full-design.md §3.6 (EDGE.4) for sessionkey. Safe only
// because internal/refractor/control/service.go's dispatchEndpoint
...
func Permissions() []pkgmgr.PermissionSpec {
	...
	perms = append(perms, personalLensPermissions("register", "deregister", "hydrate", "sessionkey")...)
	return perms
}
