...
| LoftSpace — bespoke-contracts reference package (Executable Paper) | Clause vertices as convergence targets — V1 one-time charge · V2 conditioned + judgment · V3 recurring monthly + prorated (no UDF needed after all — exact Starlark integer arithmetic). V4 (self-amendment + "why was I charged this?" FE) remains. | LoftSpace | pkg + FE | ★★★ | L | 🏗️ building · [design](../../implementation-artifacts/bespoke-contracts-executable-paper-design.md) §10 checkpoint · next: Fire V4 |
