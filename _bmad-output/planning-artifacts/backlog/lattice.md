...
| Loom / Weaver control-API surfacing | Operator pause/resume + a durable `loom.*` read model beyond what the Loupe blocker covers. | ★ | M | 🏗️ building (Chronicler) · [design](../../implementation-artifacts/orchestration-history-read-model-design.md) · regrounded 2026-07-05; next: Fire 1 (`eventStream` lens-source primitive) |
