...
> stack now: **[Weaver] drain the polluted `__effect` windows** (★★ XS–S), then **[Refractor] backfill
> the two protected lenses** (★★ XS–S) and **[CI] `edge-browser-store` retry** (★★ XS–S — Whetstone's
> lane). A stale callout starves the lane — whoever ships the top pick renames this to the next.
