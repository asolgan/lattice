...
- **Board:** this row → ✅ Andrew-ratified; Fire 0 (§9) shipped `2a5459d` (2026-07-11), independently.

## 9. Fire decomposition for the Steward

- **Fire 0 — live-bug fix (its own 📋 board row, NOT gated on this ratification) — SHIPPED `2a5459d`
  (2026-07-11):** added `$KV.credential-bindings.>` to the Gateway's matrix allow + `credential-bindings`
