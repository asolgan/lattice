...
| 1.5.10 | **Transactional event outbox** (pre-Phase-2 hardening — GATES Phase 2; persist script-returned EventList on the `op` tracker, durable consumer publishes; removes best-effort `RebuildEventListFromClasses`) | 🔜 NEXT | `pending` |
