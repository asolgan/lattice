...
test-facet-web:
	...
	node --test cmd/facet/web/degraded_render.test.mjs cmd/facet/web/edge-source.test.mjs cmd/facet/web/feed_source.test.mjs cmd/facet/web/descriptor_autofill.test.mjs
